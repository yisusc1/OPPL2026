...
export default function Home() {
  ...
  const allModules = [
    ...
    },
    {
      key: "module_ventas",
      title: "Ventas",
      description: "Gestión de actividades comerciales y solicitudes.",
      icon: ShoppingBag,
      href: "/ventas",
      cta: "Gestionar",
      bgImage: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&q=60&w=500",
      className: "col-span-1",
