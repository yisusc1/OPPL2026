-- 1. Actualizar ENUMs (Soporta re-ejecución)
...
-- 2. Agregar columna damaged_stock
ALTER TABLE inventory_products 
ADD COLUMN IF NOT EXISTS damaged_stock INTEGER DEFAULT 0;

-- 3. Recrear función RPC (Eliminando referencia a image_url)
...
BEGIN
    ...
    SELECT 
        ...
        NULL::text as image_url, -- Se retorna NULL explícitamente
        p.requires_serial,
        CASE 
