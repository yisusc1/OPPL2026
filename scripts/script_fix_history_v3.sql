-- Re-create strict serial history RPC (v3)
-- Defines the function to search for a specific serial number in all movement history
-- STRICT MODE: Only returns records where the serial number explicitly appears in the 'serials' JSONB array
-- This filters out general product movements that don't involve the specific unit.
